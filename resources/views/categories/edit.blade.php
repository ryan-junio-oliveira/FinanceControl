...
<div class="max-w-2xl">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-xl font-semibold text-gray-900">Editar Categoria</h1>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <form action="{{ route('categories.update', $category) }}" method="POST" class="divide-y divide-gray-100">
            @csrf
            @method('PUT')
