        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <form method="POST" action="{{ route('password.force.update') }}" class="divide-y divide-gray-100">
                ...
                <div class="flex justify-end px-8 py-4 bg-gray-50/60">
                    <button type="submit" class="inline-flex items-center gap-2 rounded-xl bg-cyan-800 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-cyan-800 transition-colors">
                        Alterar senha
                    </button>
                </div>
            </form>
