...
<div class="max-w-2xl">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-xl font-semibold text-gray-900">Novo Orçamento</h1>
            <p class="text-xs text-gray-400 mt-0.5">Defina um limite de gasto por período</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <form action="{{ route('budgets.store') }}" method="POST" class="divide-y divide-gray-100">
            @csrf
